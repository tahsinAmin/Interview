...
class DisjointSet {
	...
	public boolean union(long data1, long data2) {
		...
		// If they're part of same set do nothing
		...
		if(parent1.rank >= parent2.rank) {
			// increment rank onlu if both sets have same rank
...
//  	"private Map<Long, Node> map = new HashMap<>();" - Map will help me finbd the node for the given data